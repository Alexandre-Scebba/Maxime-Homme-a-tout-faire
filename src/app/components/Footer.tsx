    ...
    <footer className="w-full bg-sky-900 text-white py-6 mt-12">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-2">
        <a href="#" className="flex items-center gap-2 hover:opacity-80">
          <img src="/file.svg" alt="Placeholder Company Logo" className="w-7 h-7 rounded-full" />
          <span className="font-bold text-base">Placeholder Company</span>
        </a>
        <div className="text-xs text-center mt-2 w-full">
          &copy; {new Date().getFullYear()} Placeholder Company. All rights reserved.
        </div>
